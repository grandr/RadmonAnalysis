...
class PlotFillLumy:
    ...
    def drawAll2png(self):
        ...
        self.c = ROOT.TCanvas('c', 'Lumi', 800, 600)
        ROOT.gStyle.SetOptStat(0000);
        ...
        self.lg = ROOT.TLegend(0.6, .7, .9, .9)
        ...
        imgdump = ROOT.TImageDump(self.pngFilePattern.replace('__XXX__', str(self.fill)))
        self.c.Paint()
        imgdump.Close()
